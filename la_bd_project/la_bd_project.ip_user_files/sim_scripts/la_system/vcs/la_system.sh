...
#                script (type 'la_system.sh -help' for more information).
#
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/ec67/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/86fe/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/f0b6/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/0127/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/3cbc" +incdir+"/home/binh/Tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/ec67/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/86fe/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/f0b6/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/0127/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/3cbc" +incdir+"/home/binh/Tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.la_system xil_defaultlib.glbl -o la_system_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./la_system_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/binh/BTL_HTN_GTN_final/la_bd_project/la_bd_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key la_system_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc la_system_simv.daidir vcs_lib c.obj)
