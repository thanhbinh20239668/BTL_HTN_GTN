...
compile()
{
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/ec67/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/86fe/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/f0b6/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/0127/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/3cbc" +incdir+"/home/binh/Tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/ec67/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/86fe/hdl" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/f0b6/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/0127/hdl/verilog" +incdir+"../../../../la_bd_project.gen/sources_1/bd/la_system/ipshared/3cbc" +incdir+"/home/binh/Tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.la_system xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.la_system -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/binh/BTL_HTN_GTN_final/la_bd_project/la_bd_project.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log la_system_sc.so .tmp_log xcelium_lib waves.shm c.obj)
