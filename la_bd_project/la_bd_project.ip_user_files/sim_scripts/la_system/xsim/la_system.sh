...
#
# Script generated by Vivado on Sat Jul 18 22:46:49 +07 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : la_system.sh
...
#
# Usage        : la_system.sh
#                la_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                la_system.sh [-reset_run]
#                la_system.sh [-reset_log]
#                la_system.sh [-help]
#
...
export RDI_DATADIR="/home/binh/Tools/Xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L smartconnect_v1_0 -L xilinx_vip"

# script info
echo -e "la_system.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./la_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot la_system xil_defaultlib.la_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim la_system -key {Behavioral:sim_1:Functional:la_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_94ec.protoinst" -protoinst "protoinst_files/la_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/binh/Tools/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb la_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./la_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: la_system.sh [-help]\n\
Usage: la_system.sh [-step]\n\
Usage: la_system.sh [-lib_map_path]\n\
Usage: la_system.sh [-reset_run]\n\
Usage: la_system.sh [-reset_log]\n\
Usage: la_system.sh [-keep_index]\n\
Usage: la_system.sh [-noclean_files]\n\n\
